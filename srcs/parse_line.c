...
/*   Updated: 2021/03/30 23:33:39 by jnakahod         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_parse_line_param(t_all *all, char **line)
{
	...
	if (ft_skip_null_and_space(line, &i) == -1)
		return ;
	if ((ft_strncmp((*line + i), "NO ", 3)) && (ft_strncmp((*line + i), "SO ", 3)) && (ft_strncmp((*line + i), "WE ", 3)) && (ft_strncmp((*line + i), "EA ", 3)) && (ft_strncmp((*line + i), "S ", 2)) && (ft_strncmp((*line + i), "F ", 3)) && (ft_strncmp((*line + i), "C ", 3)))
